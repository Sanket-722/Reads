...
13. [Perpetual Future DEX] [[H] Attackers Can Profit by Creating Repeated Long or Short Positions Using Known Oracle Prices](https://certificate.quantstamp.com/full/storm-trade/21e4074a-b2cb-409d-b5df-48f683d0e8f3/index.html#findings-qs1)
14. [Uniswap V3] [[H] IchiLpOracle is extemely easy to manipulate due to how IchiVault calculates underlying token balances](https://solodit.cyfrin.io/issues/h-10-ichilporacle-is-extemely-easy-to-manipulate-due-to-how-ichivault-calculates-underlying-token-balances-sherlock-blueberry-blueberry-git)
